...
class Operation:
    ...
    **Why Static Methods?**
    ...
    def power(base: float, exponent: float) -> float:
        ...
        **Design Choice: Adding More Operations**
        - By adding more operations like power, we can extend the functionality of our 
          utility class without affecting existing methods. This adheres to the 
          **Open/Closed Principle**, allowing us to add new features without modifying 
          existing code.
        """
    ...
    def modulus(a: float, b: float) -> float:
        ...
        **Returns:**
        - `float`: The modulus of `a` divided by `b`. This is the remainder after dividing `a` by `b`.
