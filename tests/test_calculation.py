...
def test_power_calculation_execute_positive(mock_power):
    ...
    This test verifies that PowerCalculation correctly calls Operation.power
    with the provided operands and returns the expected result.
    """
    # Arrange
    a = 2.0
    b = 3.0
...
def test_modulus_calculation_execute_positive(mock_modulus):
    ...
    This test verifies that ModulusCalculation correctly calls Operation.modulus
    with the provided operands and returns the expected result.
    """
    # Arrange
    a = 10.0
...
def test_modulus_calculation_execute_zero_divisor():
    """
    Test that ModulusCalculation.execute raises ZeroDivisionError for zero divisor.

    This test covers the explicit guard branch inside ModulusCalculation.execute.
    """
    # Arrange
    modulus_calc = ModulusCalculation(10.0, 0.0)
